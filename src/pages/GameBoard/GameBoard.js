...
let ms ='Выбери три лучших хода по своему мнению';

if(localStorage.getItem('lang') == 'ru'){
  ms ='Выбери три лучших хода по своему мнению';
} 

if(localStorage.getItem('lang') == 'eng'){
  ms = 'Choose the three best moves in your opinion';
}   
  ...
  const handleHelp = ({type, multipleHandleCount, id, count} ) => {
    ...
    if (type === "score") {
      switch (id) {
        case 345:
          dispatch(setBlocked(true))
          dispatch(setsuperiority(game_id))
          break;
      
        case 59:
          dispatch(setBlocked(true))
          dispatch(setSomething(game_id))
